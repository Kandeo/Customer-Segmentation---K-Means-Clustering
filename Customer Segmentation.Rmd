...
Building a model that groups Customers accurately into non-overlapping sub-groups distinct from each other.
...
qplot( x =  Advertisement.Spend, y = "", geom = "boxplot", data = data_numeric, col = I("darkolivegreen4"), fill = I("cyan3"), main = "Advertisment ")
qplot( x =  Promotion.Spend,  y = "", geom = "boxplot", data = data_numeric, col = I("darkolivegreen4"), fill = I("cyan3"), main = "Promotion")
qplot( x =  Administration.Spend, y = "", geom = "boxplot", data = data_numeric ,col = I("darkolivegreen4"), fill = I("cyan3"), main = "Administration")
...
ggplot(data ) + 
   geom_point(mapping = aes(x = 1:nrow(data), y = Profit, color = State))
```
...
ggplot(data ) + 
   geom_point(mapping = aes(x = 1:nrow(data), y = Advertisement.Spend, shape = State))
...
ggplot(data ) + 
   geom_point(mapping = aes(x = 1:nrow(data), y = Promotion.Spend, shape = State))
...
ggplot(data ) + 
   geom_point(mapping = aes(x = 1:nrow(data), y = Administration.Spend, color  = State))
...
ggplot(data ) + 
   geom_point(mapping = aes(x = 1:nrow(data), y = expenses, color  = State))
...
# Plot the chart.
pie(total.revenue_per_state$total_total.revenue,labels = pct,col = rainbow((nrow(total.revenue_per_state))))
